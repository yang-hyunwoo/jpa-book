...
class AuthorRepositoryTest {
    ...
    @Transactional
    void manyToManyTest() {
        var book1 = givenBook("책1");
        var book2 = givenBook("책2");
        var book3 = givenBook("개발책1");
        var book4 = givenBook("개발책2");

        var author1 = givenAuthor("martin");
        var author2 = givenAuthor("steve");

        var bookAndAuthor1 = givenBookAndAuthor(book1,author1);
        var bookAndAuthor2 = givenBookAndAuthor(book2,author2);
        var bookAndAuthor3 = givenBookAndAuthor(book3,author1);
        var bookAndAuthor4 = givenBookAndAuthor(book3,author2);
        var bookAndAuthor5 = givenBookAndAuthor(book4,author1);
        var bookAndAuthor6 = givenBookAndAuthor(book4,author2);
...
//        System.out.println("books through authors : " + authorRepository.findAll().get(0).getBooks());
    ...
    private BookAndAuthor givenBookAndAuthor(Book book , Author author) {
        var bookAndAuthor = new BookAndAuthor();
