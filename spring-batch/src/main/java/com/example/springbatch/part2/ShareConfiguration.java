    ...
    public Step shareStep() {
        return stepBuilderFactory.get("shareStep")
                .tasklet((contribution, chunkContext) -> {
                    ...
                    ExecutionContext steExecutionContext = stepExecution.getExecutionContext();
                    steExecutionContext.putString("stepKey", "step execution context");
        ...
        return stepBuilderFactory.get("shareStep2")
                .tasklet((contribution, chunkContext) -> {
                    ...
                    log.info("jobKey : {} , stepKey : {}",
                            ...
                            steExecutionContext.getString("stepKey", "emptyStepKey"));
                    return RepeatStatus.FINISHED;
                }).build();
    }
